...
```{r vectors}
#6
vector_names <- c('Dori', 'Megan', 'Emma', 'Kallie') #vector with student names
vector_grades <- c(46,98,97,96) #vector with student grades
vector_pass <- c(FALSE,TRUE,TRUE,TRUE) #vector of students passing/failing
