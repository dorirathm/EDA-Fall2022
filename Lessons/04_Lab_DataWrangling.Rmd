...
NTL.1999 <- filter(NTL.phys.data, year4 == '1999')
view(NTL.1999)
...
NTL.Tuesday <- filter(NTL.phys.data, lakename == 'Tuesday Lake')
NTL.Tuesday.90.99 <- filter(NTL.Tuesday, year_num %in% c(1990:1999))
view(NTL.Tuesday.90.99)
...
Ex4 <-
  ...
  summarize(mean_surf_temp = mean(temperature_C))
