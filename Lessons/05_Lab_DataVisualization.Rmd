...
# PeterPaul.chem.nutrients$temperature_C <- filter(PeterPaul.chem.nutrients$temperature_C)
# ggplot()+
# PeterPaul.chem.nutrients%>%
#   ggplot()+
#   geom_point(aes(daynum, temperature_C))
#2. 
...
EPA.ex3<-
  ...
  geom_point(aes(color=meanLat),alpha=.5)+
